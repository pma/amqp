defmodule AMQP.Core do
  ...
  Record.defrecord :queue_unbind,        :'queue.unbind',        Record.extract(:'queue.unbind',        from_lib: "rabbit_common/include/rabbit_framing.hrl")
  Record.defrecord :queue_unbind_ok,     :'queue.unbind_ok',     Record.extract(:'queue.unbind_ok',     from_lib: "rabbit_common/include/rabbit_framing.hrl")
  Record.defrecord :queue_delete,        :'queue.delete',        Record.extract(:'queue.delete',        from_lib: "rabbit_common/include/rabbit_framing.hrl")
  Record.defrecord :queue_delete_ok,     :'queue.delete_ok',     Record.extract(:'queue.delete_ok',     from_lib: "rabbit_common/include/rabbit_framing.hrl")
  Record.defrecord :queue_purge,         :'queue.purge',         Record.extract(:'queue.purge',         from_lib: "rabbit_common/include/rabbit_framing.hrl")
  Record.defrecord :queue_purge_ok,      :'queue.purge_ok',      Record.extract(:'queue.purge_ok',      from_lib: "rabbit_common/include/rabbit_framing.hrl")
  ...
  Record.defrecord :basic_return,        :'basic.return',        Record.extract(:'basic.return',        from_lib: "rabbit_common/include/rabbit_framing.hrl")
