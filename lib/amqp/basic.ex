defmodule AMQP.Basic do
  ...
  """
  @spec publish(Channel.t, String.t, String.t, String.t, keyword) :: :ok | :blocked | :closing
  ...
  """
  @spec recover(Channel.t, keyword) :: :ok | :blocked | :closing
  ...
  """
  @spec cancel(Channel.t, String.t, keyword) :: {:ok, String.t}
